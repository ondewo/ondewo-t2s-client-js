...
(() => {
	var __webpack_modules__ = {
			...
			40: function (e, t, o) {
				...
				var m = c;
				function S(e, t) {
					if (((e.prototype = h(t.prototype)), (e.prototype.constructor = e), m)) m(e, t);
					else
						for (var o in t)
							if ('prototype' != o)
				...
				T('Array.prototype.keys', function (e) {
					...
					T('Promise', function (e) {
						...
						return (
							...
							(t.race = function (e) {
								return new t(function (t, o) {
									for (var n = d(e), s = n.next(); !s.done; s = n.next()) r(s.value).F(t, o);
								});
							}),
							(t.all = function (e) {
								var o = d(e),
				...
				function L(e, t, o) {
					return (L =
						Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf('native code') ? C : O).apply(
						null,
						arguments
					);
				}
				...
				(F.prototype.get = function (e) {
					...
					((r = N.prototype).getName = function () {
						return this.name;
					}),
					...
					(N.prototype.getRequestSerializeFn = N.prototype.getRequestSerializeFn),
					(N.prototype.getResponseDeserializeFn = N.prototype.getResponseDeserializeFn),
					(N.prototype.getRequestMessageCtor = N.prototype.getRequestMessageCtor),
					(N.prototype.getResponseMessageCtor = N.prototype.getResponseMessageCtor),
					(N.prototype.getMethodType = N.prototype.getMethodType),
					(N.prototype.getName = N.prototype.getName),
					S(B, Error),
					(B.prototype.name = 'RpcError'),
				...
				var ne,
					...
					le =
						...
						!Z(K, 'Edge'),
					pe = Z(K.toLowerCase(), 'webkit') && !Z(K, 'Edge');
				e: {
					var ue = '',
						de =
							((se = K),
					...
					if ((de && (ue = de ? de[1] : ''), ae)) {
						var ce,
							he = b.document;
						if (null != (ce = he ? he.documentMode : void 0) && ce > parseFloat(ue)) {
							ne = String(ce);
							break e;
						}
					}
						...
						for (
							...
							do {
								if (
									...
									break;
								(e =
									J(0 == s[1].length ? 0 : parseInt(s[1], 10), 0 == i[1].length ? 0 : parseInt(i[1], 10)) ||
									J(0 == s[2].length, 0 == i[2].length) ||
									J(s[2], i[2])),
									(s = s[3]),
									(i = i[3]);
							} while (0 == e);
				...
				function me() {
					0 != Se && ((Object.prototype.hasOwnProperty.call(this, A) && this[A]) || (this[A] = ++M)), (this.K = this.K);
				}
				var Se = 0;
				me.prototype.K = !1;
				var Te =
				...
				var be = (function () {
					...
					try {
						b.addEventListener('test', E, t), b.removeEventListener('test', E, t);
					} catch (e) {}
					return e;
				})();
				function we(e, t) {
				...
				v(we, _e);
				var Ee = Te({ 2: 'touch', 3: 'pen', 4: 'mouse' });
				...
				function Pe(e, t, o, r, n) {
					...
					else (o = Ge(o)), e && e[Re] ? e.f.add(String(t), o, !1, R(r) ? !!r.capture : !!r, n) : Ne(e, t, o, !1, r, n);
				}
				function Ne(e, t, o, r, n, s) {
					if (!t) throw Error('Invalid event type');
					var i = R(n) ? !!n.capture : !!n,
						a = We(e);
					if ((a || (e[Fe] = a = new Oe(e)), !(o = a.add(t, o, r, i, s)).proxy)) {
						if (
							((r = (function () {
								function e(o) {
							...
							be || (n = i), void 0 === n && (n = !1), e.addEventListener(t.toString(), r, n);
				...
				function je(e, t, o, r, n) {
					...
					else (o = Ge(o)), e && e[Re] ? e.f.add(String(t), o, !0, R(r) ? !!r.capture : !!r, n) : Ne(e, t, o, !0, r, n);
				}
					...
					if (Array.isArray(t)) for (var s = 0; s < t.length; s++) Be(e, t[s], o, r, n);
						...
						(r = R(r) ? !!r.capture : !!r),
							...
							e && e[Re]
								...
								: e &&
								  (e = We(e)) &&
								  ((t = e.a[t.toString()]), (e = -1), t && (e = ve(t, o, r, n)), (o = -1 < e ? t[e] : null) && De(o));
				}
				function De(e) {
					if ('number' != typeof e && e && !e.A) {
						...
						if (t && t[Re]) Le(t.f, e);
							...
							t.removeEventListener
								...
								(o = We(t)) ? (Le(o, e), 0 == o.b && ((o.src = null), (t[Fe] = null))) : Ce(e);
						}
					}
				}
				function Ue(e) {
				...
				function ze(e, t) {
					if (e.A) e = !0;
						...
						var o = e.listener,
							r = e.H || e.src;
						e.D && De(e), (e = o.call(r, t));
					}
					return e;
				}
				function We(e) {
					return (e = e[Fe]) instanceof Oe ? e : null;
				}
				...
				function He() {
					me.call(this), (this.f = new Oe(this)), (this.U = this);
				}
				function ke(e, t) {
					e = e.U;
					var o = t.type || t;
				...
				function rt(e, t, o) {
					this.reset(e || Je, t, o, void 0, void 0);
				}
				function nt(e, t) {
					(this.a = null),
						(this.f = []),
				...
				function lt(e, t, o) {
					var r;
					(r = e) && (r = e && t) && (r = (r = t.value) >= (e ? st(at(gt(), e.getName())) : Je).value);
					r &&
						((t = t || Je),
						(r = at(gt(), e.getName())),
				...
				(ot.prototype.clear = function () {}),
					...
					a(),
					u();
				var mt = 'StopIteration' in b ? b.StopIteration : { message: 'StopIteration', stack: '' };
				function St() {}
				function Tt(e) {
					if (e instanceof bt || e instanceof wt || e instanceof Et) return e;
				...
				(St.prototype.next = function () {
					...
					(r.delete = function (e) {
						return (
							!!Mt(this.o, e) &&
							(delete this.o[e], --this.size, this.B++, this.j.length > 2 * this.size && At(this), !0)
						);
					}),
					(r.get = function (e, t) {
				...
				v(Ot, He);
				var Lt = '';
				Ot.prototype.b = at(gt(), 'goog.net.XhrIo', void 0).g;
				var vt = /^https?$/i,
					Ft = ['POST', 'PUT'];
				function It(e, t, o) {
					...
					(e.v = t),
						...
						(e.L = !1),
						(e.c = !0),
						(e.a = e.C ? ht(e.C) : ht(Ze)),
						(e.J = e.C ? dt(e.C) : dt(Ze)),
						(e.a.onreadystatechange = L(e.R, e));
					try {
						pt(e.b, Wt(e, 'Opening Xhr')), (e.N = !0), e.a.open('POST', String(t), !0), (e.N = !1);
					} catch (t) {
						return pt(e.b, Wt(e, 'Error opening Xhr: ' + t.message)), void Pt(e, t);
					}
					t = o || '';
					...
					try {
						Dt(e),
							0 < e.h &&
								...
								pt(e.b, Wt(e, 'Will abort after ' + e.h + 'ms if incomplete, xhr2 ' + e.I)),
								e.I ? ((e.a.timeout = e.h), (e.a.ontimeout = L(e.T, e))) : (e.w = Ye(e.T, e.h, e))),
							pt(e.b, Wt(e, 'Sending request')),
							(e.s = !0),
							e.a.send(t),
							(e.s = !1);
					} catch (t) {
						pt(e.b, Wt(e, 'Send error: ' + t.message)), Pt(e, t);
					}
				}
				function Pt(e, t) {
					(e.c = !1), e.a && ((e.i = !0), e.a.abort(), (e.i = !1)), (e.l = t), (e.g = 5), Nt(e), Bt(e);
				}
				function Nt(e) {
				...
				function jt(e) {
					if (e.c && void 0 !== _)
						if (e.J[1] && 4 == Ut(e) && 2 == e.getStatus()) pt(e.b, Wt(e, 'Local request error detected and ignored'));
						else if (e.s && 4 == Ut(e)) Ye(e.R, 0, e);
						else if ((ke(e, 'readystatechange'), 4 == Ut(e))) {
							pt(e.b, Wt(e, 'Request complete')), (e.c = !1);
							try {
								var t,
									o = e.getStatus();
								e: switch (o) {
								...
								if (!(t = r)) {
									var n;
									if ((n = 0 === o)) {
										var s = String(e.v).match(Ct)[1] || null;
										if (!s && b.self && b.self.location) {
											var i = b.self.location.protocol;
											s = i.substr(0, i.length - 1);
										}
										n = !vt.test(s ? s.toLowerCase() : '');
									}
									t = n;
								}
								if (t) ke(e, 'complete'), ke(e, 'success');
								else {
									e.g = 6;
									try {
					...
					Pe(this.a, 'readystatechange', function () {
						...
						if ((e = e.a ? e.a.getResponseHeader('Content-Type') : null)) {
							if (0 == (e = e.toLowerCase()).lastIndexOf('application/grpc-web-text', 0)) {
								...
								if (0 != e.lastIndexOf('application/grpc', 0))
									return void Kt(t, new B(2, 'Unknown Content-type received.'));
								e = new Uint8Array(
									(function (e) {
										try {
											if (!e.a) return null;
							...
							try {
									...
									for (s = t instanceof Uint8Array || t instanceof Array ? t : new Uint8Array(t); g < s.length; ) {
										switch (a.b) {
											case k:
												...
												break;
											case x:
												(i = s[g]) == V || i == q ? (a.h = i) : Y(a, s, g, 'invalid frame byte'),
													(a.b = G),
													(a.a = 0),
													(a.f = 0);
												break;
								...
								Kt(t, new B(2, 'Error in parsing response body'));
							}
							if (o)
									...
									if (V in o[e]) {
										...
										if (r) {
											...
											try {
												...
												Kt(t, new B(13, 'Error when deserializing response data; error: ' + e + ', response: ' + n));
											}
											if (n) {
												r = t;
						...
						Pe(this.a, 'complete', function () {
							...
							if (
								...
								(e = !1),
									'grpc-status' in s &&
										((o = Number(zt(t.a, 'grpc-status'))),
										'grpc-message' in s && (r = zt(t.a, 'grpc-message')),
										0 != o && (Kt(t, new B(o, r || '', s)), (e = !0))),
									e ||
										(function (e) {
				...
				function Kt(e, t) {
					if (0 != t.code)
						for (var o = new B(t.code, decodeURIComponent(t.message || ''), t.metadata), r = 0; r < e.f.length; r++)
							e.f[r](o);
					for (
				...
				function Xt(e, t, o) {
					...
					if (
						...
						a = {};
						for (var g = d((i = o.headers).keys()), l = g.next(); !l.done; l = g.next()) a[(l = l.value)] = i.get(l);
						o.headers.clear();
						e: {
							for (p in a) {
								var p = !1;
				...
				(qt.prototype.on = function (e, t) {
					...
					(e.exports.MethodDescriptor = N),
					(e.exports.GrpcWebClientBase = $t),
					(e.exports.RpcError = B),
			...
			264: (e, t, o) => {
				...
				const s = { ondewo: {} };
				(s.ondewo.t2s = o(893)),
					(s.ondewo.t2s.Text2SpeechClient = function (e, t, o) {
						o || (o = {}), (o.format = 'text'), (this.client_ = new r.web.GrpcWebClientBase(o)), (this.hostname_ = e);
					}),
					(s.ondewo.t2s.Text2SpeechPromiseClient = function (e, t, o) {
						o || (o = {}), (o.format = 'text'), (this.client_ = new r.web.GrpcWebClientBase(o)), (this.hostname_ = e);
					});
				const i = new r.web.MethodDescriptor(
					'/ondewo.t2s.Text2Speech/Synthesize',
					r.web.MethodType.UNARY,
					s.ondewo.t2s.SynthesizeRequest,
					s.ondewo.t2s.SynthesizeResponse,
					function (e) {
						return e.serializeBinary();
					},
					s.ondewo.t2s.SynthesizeResponse.deserializeBinary
				);
				(s.ondewo.t2s.Text2SpeechClient.prototype.synthesize = function (e, t, o) {
					return this.client_.rpcCall(this.hostname_ + '/ondewo.t2s.Text2Speech/Synthesize', e, t || {}, i, o);
				}),
					(s.ondewo.t2s.Text2SpeechPromiseClient.prototype.synthesize = function (e, t) {
						return this.client_.unaryCall(this.hostname_ + '/ondewo.t2s.Text2Speech/Synthesize', e, t || {}, i);
					});
				const a = new r.web.MethodDescriptor(
					'/ondewo.t2s.Text2Speech/BatchSynthesize',
					r.web.MethodType.UNARY,
					s.ondewo.t2s.BatchSynthesizeRequest,
					s.ondewo.t2s.BatchSynthesizeResponse,
					function (e) {
						return e.serializeBinary();
					},
					s.ondewo.t2s.BatchSynthesizeResponse.deserializeBinary
				);
				(s.ondewo.t2s.Text2SpeechClient.prototype.batchSynthesize = function (e, t, o) {
					return this.client_.rpcCall(this.hostname_ + '/ondewo.t2s.Text2Speech/BatchSynthesize', e, t || {}, a, o);
				}),
					(s.ondewo.t2s.Text2SpeechPromiseClient.prototype.batchSynthesize = function (e, t) {
				...
				const g = new r.web.MethodDescriptor(
					...
					r.web.MethodType.UNARY,
					s.ondewo.t2s.NormalizeTextRequest,
					s.ondewo.t2s.NormalizeTextResponse,
					function (e) {
						return e.serializeBinary();
					},
					s.ondewo.t2s.NormalizeTextResponse.deserializeBinary
				);
				(s.ondewo.t2s.Text2SpeechClient.prototype.normalizeText = function (e, t, o) {
					return this.client_.rpcCall(this.hostname_ + '/ondewo.t2s.Text2Speech/NormalizeText', e, t || {}, g, o);
				}),
					(s.ondewo.t2s.Text2SpeechPromiseClient.prototype.normalizeText = function (e, t) {
						return this.client_.unaryCall(this.hostname_ + '/ondewo.t2s.Text2Speech/NormalizeText', e, t || {}, g);
					});
				const l = new r.web.MethodDescriptor(
					'/ondewo.t2s.Text2Speech/GetT2sPipeline',
					r.web.MethodType.UNARY,
					s.ondewo.t2s.T2sPipelineId,
					s.ondewo.t2s.Text2SpeechConfig,
					function (e) {
						return e.serializeBinary();
					},
					s.ondewo.t2s.Text2SpeechConfig.deserializeBinary
				);
				(s.ondewo.t2s.Text2SpeechClient.prototype.getT2sPipeline = function (e, t, o) {
					return this.client_.rpcCall(this.hostname_ + '/ondewo.t2s.Text2Speech/GetT2sPipeline', e, t || {}, l, o);
				}),
					(s.ondewo.t2s.Text2SpeechPromiseClient.prototype.getT2sPipeline = function (e, t) {
				...
				const p = new r.web.MethodDescriptor(
					...
					s.ondewo.t2s.T2sPipelineId.deserializeBinary
				);
				(s.ondewo.t2s.Text2SpeechClient.prototype.createT2sPipeline = function (e, t, o) {
					return this.client_.rpcCall(this.hostname_ + '/ondewo.t2s.Text2Speech/CreateT2sPipeline', e, t || {}, p, o);
				}),
					(s.ondewo.t2s.Text2SpeechPromiseClient.prototype.createT2sPipeline = function (e, t) {
						return this.client_.unaryCall(this.hostname_ + '/ondewo.t2s.Text2Speech/CreateT2sPipeline', e, t || {}, p);
					});
				...
				(s.ondewo.t2s.Text2SpeechClient.prototype.deleteT2sPipeline = function (e, t, o) {
					return this.client_.rpcCall(this.hostname_ + '/ondewo.t2s.Text2Speech/DeleteT2sPipeline', e, t || {}, u, o);
				}),
					(s.ondewo.t2s.Text2SpeechPromiseClient.prototype.deleteT2sPipeline = function (e, t) {
						return this.client_.unaryCall(this.hostname_ + '/ondewo.t2s.Text2Speech/DeleteT2sPipeline', e, t || {}, u);
					});
				...
				(s.ondewo.t2s.Text2SpeechClient.prototype.updateT2sPipeline = function (e, t, o) {
					return this.client_.rpcCall(this.hostname_ + '/ondewo.t2s.Text2Speech/UpdateT2sPipeline', e, t || {}, d, o);
				}),
					(s.ondewo.t2s.Text2SpeechPromiseClient.prototype.updateT2sPipeline = function (e, t) {
						return this.client_.unaryCall(this.hostname_ + '/ondewo.t2s.Text2Speech/UpdateT2sPipeline', e, t || {}, d);
					});
				const c = new r.web.MethodDescriptor(
					'/ondewo.t2s.Text2Speech/ListT2sPipelines',
					r.web.MethodType.UNARY,
					s.ondewo.t2s.ListT2sPipelinesRequest,
					s.ondewo.t2s.ListT2sPipelinesResponse,
					function (e) {
						return e.serializeBinary();
					},
					s.ondewo.t2s.ListT2sPipelinesResponse.deserializeBinary
				);
				(s.ondewo.t2s.Text2SpeechClient.prototype.listT2sPipelines = function (e, t, o) {
					return this.client_.rpcCall(this.hostname_ + '/ondewo.t2s.Text2Speech/ListT2sPipelines', e, t || {}, c, o);
				}),
					(s.ondewo.t2s.Text2SpeechPromiseClient.prototype.listT2sPipelines = function (e, t) {
				...
				const h = new r.web.MethodDescriptor(
					...
					r.web.MethodType.UNARY,
					s.ondewo.t2s.ListT2sLanguagesRequest,
					s.ondewo.t2s.ListT2sLanguagesResponse,
					function (e) {
						return e.serializeBinary();
					},
					s.ondewo.t2s.ListT2sLanguagesResponse.deserializeBinary
				);
				(s.ondewo.t2s.Text2SpeechClient.prototype.listT2sLanguages = function (e, t, o) {
					return this.client_.rpcCall(this.hostname_ + '/ondewo.t2s.Text2Speech/ListT2sLanguages', e, t || {}, h, o);
				}),
					(s.ondewo.t2s.Text2SpeechPromiseClient.prototype.listT2sLanguages = function (e, t) {
				...
				const f = new r.web.MethodDescriptor(
					...
					r.web.MethodType.UNARY,
					s.ondewo.t2s.ListT2sDomainsRequest,
					s.ondewo.t2s.ListT2sDomainsResponse,
					function (e) {
						return e.serializeBinary();
					},
					s.ondewo.t2s.ListT2sDomainsResponse.deserializeBinary
				);
				(s.ondewo.t2s.Text2SpeechClient.prototype.listT2sDomains = function (e, t, o) {
					return this.client_.rpcCall(this.hostname_ + '/ondewo.t2s.Text2Speech/ListT2sDomains', e, t || {}, f, o);
				}),
					(s.ondewo.t2s.Text2SpeechPromiseClient.prototype.listT2sDomains = function (e, t) {
				...
				const y = new r.web.MethodDescriptor(
					...
					r.web.MethodType.UNARY,
					n.Empty,
					s.ondewo.t2s.T2SGetServiceInfoResponse,
					function (e) {
						return e.serializeBinary();
					},
					s.ondewo.t2s.T2SGetServiceInfoResponse.deserializeBinary
				);
				(s.ondewo.t2s.Text2SpeechClient.prototype.getServiceInfo = function (e, t, o) {
					return this.client_.rpcCall(this.hostname_ + '/ondewo.t2s.Text2Speech/GetServiceInfo', e, t || {}, y, o);
				}),
					(s.ondewo.t2s.Text2SpeechPromiseClient.prototype.getServiceInfo = function (e, t) {
						return this.client_.unaryCall(this.hostname_ + '/ondewo.t2s.Text2Speech/GetServiceInfo', e, t || {}, y);
					}),
					(s.ondewo.t2s.CustomPhonemizersClient = function (e, t, o) {
						o || (o = {}), (o.format = 'text'), (this.client_ = new r.web.GrpcWebClientBase(o)), (this.hostname_ = e);
					}),
					(s.ondewo.t2s.CustomPhonemizersPromiseClient = function (e, t, o) {
						o || (o = {}), (o.format = 'text'), (this.client_ = new r.web.GrpcWebClientBase(o)), (this.hostname_ = e);
					});
				const m = new r.web.MethodDescriptor(
					'/ondewo.t2s.CustomPhonemizers/GetCustomPhonemizer',
					r.web.MethodType.UNARY,
					s.ondewo.t2s.PhonemizerId,
					s.ondewo.t2s.CustomPhonemizerProto,
					function (e) {
						return e.serializeBinary();
					},
					s.ondewo.t2s.CustomPhonemizerProto.deserializeBinary
				);
				(s.ondewo.t2s.CustomPhonemizersClient.prototype.getCustomPhonemizer = function (e, t, o) {
					...
					(s.ondewo.t2s.CustomPhonemizersPromiseClient.prototype.getCustomPhonemizer = function (e, t) {
				...
				const S = new r.web.MethodDescriptor(
					...
					r.web.MethodType.UNARY,
					s.ondewo.t2s.CreateCustomPhonemizerRequest,
					s.ondewo.t2s.PhonemizerId,
					function (e) {
						return e.serializeBinary();
					},
					s.ondewo.t2s.PhonemizerId.deserializeBinary
				);
				(s.ondewo.t2s.CustomPhonemizersClient.prototype.createCustomPhonemizer = function (e, t, o) {
					return this.client_.rpcCall(
					...
					(s.ondewo.t2s.CustomPhonemizersPromiseClient.prototype.createCustomPhonemizer = function (e, t) {
						return this.client_.unaryCall(
							this.hostname_ + '/ondewo.t2s.CustomPhonemizers/CreateCustomPhonemizer',
							e,
							t || {},
				...
				(s.ondewo.t2s.CustomPhonemizersClient.prototype.deleteCustomPhonemizer = function (e, t, o) {
					return this.client_.rpcCall(
					...
					(s.ondewo.t2s.CustomPhonemizersPromiseClient.prototype.deleteCustomPhonemizer = function (e, t) {
						return this.client_.unaryCall(
							this.hostname_ + '/ondewo.t2s.CustomPhonemizers/DeleteCustomPhonemizer',
							e,
							t || {},
				...
				const _ = new r.web.MethodDescriptor(
					'/ondewo.t2s.CustomPhonemizers/UpdateCustomPhonemizer',
					r.web.MethodType.UNARY,
					s.ondewo.t2s.UpdateCustomPhonemizerRequest,
					s.ondewo.t2s.CustomPhonemizerProto,
					function (e) {
						return e.serializeBinary();
					},
				...
				(s.ondewo.t2s.CustomPhonemizersClient.prototype.updateCustomPhonemizer = function (e, t, o) {
					return this.client_.rpcCall(
					...
					(s.ondewo.t2s.CustomPhonemizersPromiseClient.prototype.updateCustomPhonemizer = function (e, t) {
						return this.client_.unaryCall(
							this.hostname_ + '/ondewo.t2s.CustomPhonemizers/UpdateCustomPhonemizer',
							e,
							t || {},
				...
				const b = new r.web.MethodDescriptor(
					...
					r.web.MethodType.UNARY,
					s.ondewo.t2s.ListCustomPhonemizerRequest,
					s.ondewo.t2s.ListCustomPhonemizerResponse,
					function (e) {
						return e.serializeBinary();
					},
					s.ondewo.t2s.ListCustomPhonemizerResponse.deserializeBinary
				);
				(s.ondewo.t2s.CustomPhonemizersClient.prototype.listCustomPhonemizer = function (e, t, o) {
					return this.client_.rpcCall(
					...
					(s.ondewo.t2s.CustomPhonemizersPromiseClient.prototype.listCustomPhonemizer = function (e, t) {
						return this.client_.unaryCall(
							this.hostname_ + '/ondewo.t2s.CustomPhonemizers/ListCustomPhonemizer',
							e,
							t || {},
					...
					(s.ondewo.t2s.Text2SpeechClientWrapper = function (e) {
						return (
							...
							s.ondewo.t2s.Text2SpeechClient.call(this, this.w_hostport, this.w_credentials, this.w_options)
						);
					}),
					(s.ondewo.t2s.Text2SpeechPromiseClientWrapper = function (e) {
						return (
							(this.w_host = e.grpc_host),
							(this.w_port = e.grpc_port),
							(this.w_certificate = e.grpc_certificate),
							...
							e && e.options && Object.assign(this.w_options, e.options),
							(this.w_hostport = this.w_host + ':' + this.w_port),
							s.ondewo.t2s.Text2SpeechPromiseClient.call(this, this.w_hostport, this.w_credentials, this.w_options)
						);
					}),
					(s.ondewo.t2s.CustomPhonemizersClientWrapper = function (e) {
						return (
							(this.w_host = e.grpc_host),
							(this.w_port = e.grpc_port),
							(this.w_certificate = e.grpc_certificate),
							...
							e && e.options && Object.assign(this.w_options, e.options),
							(this.w_hostport = this.w_host + ':' + this.w_port),
							s.ondewo.t2s.CustomPhonemizersClient.call(this, this.w_hostport, this.w_credentials, this.w_options)
						);
					}),
					(s.ondewo.t2s.CustomPhonemizersPromiseClientWrapper = function (e) {
						return (
							(this.w_host = e.grpc_host),
							(this.w_port = e.grpc_port),
							(this.w_certificate = e.grpc_certificate),
							...
							e && e.options && Object.assign(this.w_options, e.options),
							(this.w_hostport = this.w_host + ':' + this.w_port),
							s.ondewo.t2s.CustomPhonemizersPromiseClient.call(
								this,
								this.w_hostport,
								this.w_credentials,
								this.w_options
			...
			893: (e, t, o) => {
				...
				n.object.extend(proto, i),
					n.exportSymbol('proto.ondewo.t2s.Apodization', null, s),
					n.exportSymbol('proto.ondewo.t2s.AudioFormat', null, s),
					n.exportSymbol('proto.ondewo.t2s.BatchSynthesizeRequest', null, s),
					n.exportSymbol('proto.ondewo.t2s.BatchSynthesizeResponse', null, s),
					n.exportSymbol('proto.ondewo.t2s.Caching', null, s),
					n.exportSymbol('proto.ondewo.t2s.CompositeInference', null, s),
					n.exportSymbol('proto.ondewo.t2s.CreateCustomPhonemizerRequest', null, s),
					n.exportSymbol('proto.ondewo.t2s.CustomPhonemizerProto', null, s),
					n.exportSymbol('proto.ondewo.t2s.GlowTTS', null, s),
					n.exportSymbol('proto.ondewo.t2s.GlowTTSTriton', null, s),
					n.exportSymbol('proto.ondewo.t2s.HiFiGan', null, s),
					n.exportSymbol('proto.ondewo.t2s.HiFiGanTriton', null, s),
					n.exportSymbol('proto.ondewo.t2s.ListCustomPhonemizerRequest', null, s),
					n.exportSymbol('proto.ondewo.t2s.ListCustomPhonemizerResponse', null, s),
					n.exportSymbol('proto.ondewo.t2s.ListT2sDomainsRequest', null, s),
					n.exportSymbol('proto.ondewo.t2s.ListT2sDomainsResponse', null, s),
					n.exportSymbol('proto.ondewo.t2s.ListT2sLanguagesRequest', null, s),
					n.exportSymbol('proto.ondewo.t2s.ListT2sLanguagesResponse', null, s),
					n.exportSymbol('proto.ondewo.t2s.ListT2sPipelinesRequest', null, s),
					n.exportSymbol('proto.ondewo.t2s.ListT2sPipelinesResponse', null, s),
					n.exportSymbol('proto.ondewo.t2s.Logmnse', null, s),
					n.exportSymbol('proto.ondewo.t2s.Map', null, s),
					n.exportSymbol('proto.ondewo.t2s.MbMelganTriton', null, s),
					n.exportSymbol('proto.ondewo.t2s.Mel2Audio', null, s),
					n.exportSymbol('proto.ondewo.t2s.NormalizeTextRequest', null, s),
					n.exportSymbol('proto.ondewo.t2s.NormalizeTextResponse', null, s),
					n.exportSymbol('proto.ondewo.t2s.Pcm', null, s),
					n.exportSymbol('proto.ondewo.t2s.PhonemizerId', null, s),
					n.exportSymbol('proto.ondewo.t2s.Postprocessing', null, s),
					n.exportSymbol('proto.ondewo.t2s.RequestConfig', null, s),
					n.exportSymbol('proto.ondewo.t2s.RequestConfig.OneofAudioformatCase', null, s),
					n.exportSymbol('proto.ondewo.t2s.RequestConfig.OneofLengthScaleCase', null, s),
					n.exportSymbol('proto.ondewo.t2s.RequestConfig.OneofNoiseScaleCase', null, s),
					n.exportSymbol('proto.ondewo.t2s.RequestConfig.OneofNormalizerCase', null, s),
					n.exportSymbol('proto.ondewo.t2s.RequestConfig.OneofPcmCase', null, s),
					n.exportSymbol('proto.ondewo.t2s.RequestConfig.OneofSampleRateCase', null, s),
					n.exportSymbol('proto.ondewo.t2s.RequestConfig.OneofUseCacheCase', null, s),
					n.exportSymbol('proto.ondewo.t2s.SynthesizeRequest', null, s),
					n.exportSymbol('proto.ondewo.t2s.SynthesizeResponse', null, s),
					n.exportSymbol('proto.ondewo.t2s.T2SCustomLengthScales', null, s),
					n.exportSymbol('proto.ondewo.t2s.T2SDescription', null, s),
					n.exportSymbol('proto.ondewo.t2s.T2SGetServiceInfoResponse', null, s),
					n.exportSymbol('proto.ondewo.t2s.T2SInference', null, s),
					n.exportSymbol('proto.ondewo.t2s.T2SNormalization', null, s),
					n.exportSymbol('proto.ondewo.t2s.T2sPipelineId', null, s),
					n.exportSymbol('proto.ondewo.t2s.Text2Mel', null, s),
					n.exportSymbol('proto.ondewo.t2s.Text2SpeechConfig', null, s),
					n.exportSymbol('proto.ondewo.t2s.UpdateCustomPhonemizerRequest', null, s),
					n.exportSymbol('proto.ondewo.t2s.UpdateCustomPhonemizerRequest.UpdateMethod', null, s),
					n.exportSymbol('proto.ondewo.t2s.Wiener', null, s),
